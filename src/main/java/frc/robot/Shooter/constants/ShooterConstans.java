...
public class ShooterConstans {
        ...
        public static final double SHOOTER_GEAR_RATIO = 3 * 0.0254;
        ...
        public static final double SHOOTER_KD = 0d;
        ...
        public static final double SHOOTER_KG = 0d;
        ...
        public static final TalonFXConfig SHOOTER_MOTOR_CONFIG = new TalonFXConfig(SHOOTER_MOTOR_ID, SHOOTER_CANBUS,
                        ...
                        .withMeterMotor(1, SHOOTER_GEAR_RATIO);
        ...
        public static final double MAX_HOOD_ANGLE_ERROR = Math.toRadians(0.8);
