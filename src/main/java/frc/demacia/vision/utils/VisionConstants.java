...
public class VisionConstants {
    ...
    public static final Rotation3d YAW_OFFSET_QUEST = new Rotation3d(0, 0, 180);
    ...
    public static class Tags {
        public static final ArrayList<TagPose> LIMELIGHTS_ARRAY_LIST = new ArrayList<>() {
            {
                new TagPose(new Camera("hub", new Translation3d(-0.133, 0.19, 0.545), 30.0, 0.0, false,
                        0.1879));
